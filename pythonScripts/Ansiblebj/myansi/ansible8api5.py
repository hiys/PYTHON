...
#[root@V1 myansi]# head    -2    /root/myansi/myhosts
#[dbservers]
#V3
...
#  hosts = 'localhost',  #执行ansible管理命令的主机地址
#[root@V1 myansi]# grep  -nA1  "\[dbservers\]"   /root/myansi/myhosts
#1:[dbservers]
#2-V3
  hosts = 'dbservers',  #执行ansible管理命令的主机地址(在主机列表清单中查找)
  gather_facts = 'no',
  tasks = [
