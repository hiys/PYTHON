...
#通过表的映射类,在数据库中创建表,enginex是引擎<class 'sqlalchemy.engine.base.Engine'>
...
#[root@V0 devops_day02]# python3  alchemy_create_engine4.py 
...
#-----------OK----------------
#
#2019-04-24 16:08:40,130 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'sql_mode'
#2019-04-24 16:08:40,130 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,131 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'lower_case_table_names'
#2019-04-24 16:08:40,131 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,132 INFO sqlalchemy.engine.base.Engine SELECT DATABASE()
#2019-04-24 16:08:40,132 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,133 INFO sqlalchemy.engine.base.Engine show collation where `Charset` = 'utf8mb4' and `Collation` = 'utf8mb4_bin'
#2019-04-24 16:08:40,133 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,135 INFO sqlalchemy.engine.base.Engine SELECT CAST('test plain returns' AS CHAR(60)) AS anon_1
#2019-04-24 16:08:40,135 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,136 INFO sqlalchemy.engine.base.Engine SELECT CAST('test unicode returns' AS CHAR(60)) AS anon_1
#2019-04-24 16:08:40,136 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,136 INFO sqlalchemy.engine.base.Engine SELECT CAST('test collated returns' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_bin AS anon_1
#2019-04-24 16:08:40,136 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,138 INFO sqlalchemy.engine.base.Engine DESCRIBE `departments`
#2019-04-24 16:08:40,138 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,138 INFO sqlalchemy.engine.base.Engine ROLLBACK
#2019-04-24 16:08:40,139 INFO sqlalchemy.engine.base.Engine 
...
#
#2019-04-24 16:08:40,139 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 16:08:40,168 INFO sqlalchemy.engine.base.Engine COMMIT
...
#
#session = <sqlalchemy.orm.session.Session object at 0x7f293d88eb70>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#2019-04-24 16:08:40,170 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 16:08:40,171 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 16:08:40,171 INFO sqlalchemy.engine.base.Engine {'dep_name': '人事部'}
#2019-04-24 16:08:40,173 INFO sqlalchemy.engine.base.Engine COMMIT
#
#session = <sqlalchemy.orm.session.Session object at 0x7f293d88eb70>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#2019-04-24 16:08:40,178 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 16:08:40,178 INFO sqlalchemy.engine.base.Engine SELECT departments.dep_id AS departments_dep_id, departments.dep_name AS departments_dep_name 
#FROM departments 
#WHERE departments.dep_id = %(param_1)s
#2019-04-24 16:08:40,179 INFO sqlalchemy.engine.base.Engine {'param_1': 1}
#
#hr.dep_id= 1
#
#2019-04-24 16:08:40,180 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 16:08:40,180 INFO sqlalchemy.engine.base.Engine {'dep_name': '开发部'}
#2019-04-24 16:08:40,181 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 16:08:40,181 INFO sqlalchemy.engine.base.Engine {'dep_name': '运维部'}
#2019-04-24 16:08:40,182 INFO sqlalchemy.engine.base.Engine COMMIT
#-----OK ---- rcmd is:
#2019年 04月 24日 星期三 16:08:40 CST
# --------
#
#+-------------------+
#| Tables_in_alchemy |
...
#-----OK ---- rcmd2  --------
#
# sys.argv[0]  is alchemy_create_engine4.py
#
