...
#[root@V0 devops_day02]# python3   alchemy_create_engine5.py
...
#
#session = <sqlalchemy.orm.session.Session object at 0x7fa66f003438>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#ERROR 1051 (42S02) at line 1: Unknown table 'salary'
#-----returncmd = 1 -------
#
#2019-04-24 17:32:22,716 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'sql_mode'
#2019-04-24 17:32:22,716 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,717 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'lower_case_table_names'
#2019-04-24 17:32:22,717 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,718 INFO sqlalchemy.engine.base.Engine SELECT DATABASE()
#2019-04-24 17:32:22,718 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,719 INFO sqlalchemy.engine.base.Engine show collation where `Charset` = 'utf8mb4' and `Collation` = 'utf8mb4_bin'
#2019-04-24 17:32:22,719 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,720 INFO sqlalchemy.engine.base.Engine SELECT CAST('test plain returns' AS CHAR(60)) AS anon_1
#2019-04-24 17:32:22,720 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,721 INFO sqlalchemy.engine.base.Engine SELECT CAST('test unicode returns' AS CHAR(60)) AS anon_1
#2019-04-24 17:32:22,721 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,722 INFO sqlalchemy.engine.base.Engine SELECT CAST('test collated returns' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_bin AS anon_1
#2019-04-24 17:32:22,722 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,723 INFO sqlalchemy.engine.base.Engine DESCRIBE `departments`
#2019-04-24 17:32:22,723 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,724 INFO sqlalchemy.engine.base.Engine ROLLBACK
#2019-04-24 17:32:22,724 INFO sqlalchemy.engine.base.Engine DESCRIBE `employees`
#2019-04-24 17:32:22,724 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,724 INFO sqlalchemy.engine.base.Engine ROLLBACK
#2019-04-24 17:32:22,725 INFO sqlalchemy.engine.base.Engine DESCRIBE `salary`
#2019-04-24 17:32:22,725 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,725 INFO sqlalchemy.engine.base.Engine ROLLBACK
#2019-04-24 17:32:22,726 INFO sqlalchemy.engine.base.Engine 
...
#
#2019-04-24 17:32:22,726 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,790 INFO sqlalchemy.engine.base.Engine COMMIT
#2019-04-24 17:32:22,792 INFO sqlalchemy.engine.base.Engine 
...
#
#2019-04-24 17:32:22,792 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,848 INFO sqlalchemy.engine.base.Engine COMMIT
#2019-04-24 17:32:22,851 INFO sqlalchemy.engine.base.Engine 
#CREATE TABLE salary (
...
#
#2019-04-24 17:32:22,851 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 17:32:22,890 INFO sqlalchemy.engine.base.Engine COMMIT
...
#
#2019-04-24 17:32:22,897 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 17:32:22,900 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 17:32:22,900 INFO sqlalchemy.engine.base.Engine {'dep_name': '人事部'}
#2019-04-24 17:32:22,903 INFO sqlalchemy.engine.base.Engine COMMIT
#
#session = <sqlalchemy.orm.session.Session object at 0x7fa66f003438>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#2019-04-24 17:32:22,917 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 17:32:22,919 INFO sqlalchemy.engine.base.Engine SELECT departments.dep_id AS departments_dep_id, departments.dep_name AS departments_dep_name 
#FROM departments 
#WHERE departments.dep_id = %(param_1)s
#2019-04-24 17:32:22,919 INFO sqlalchemy.engine.base.Engine {'param_1': 1}
#
#hr.dep_id= 1
#
#2019-04-24 17:32:22,923 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 17:32:22,923 INFO sqlalchemy.engine.base.Engine {'dep_name': '开发部'}
#2019-04-24 17:32:22,925 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 17:32:22,925 INFO sqlalchemy.engine.base.Engine {'dep_name': '运维部'}
#2019-04-24 17:32:22,927 INFO sqlalchemy.engine.base.Engine COMMIT
#-----OK ---- rcmd is:
#2019年 04月 24日 星期三 17:32:22 CST
# --------
#
#+-------------------+
#| Tables_in_alchemy |
...
#-----OK ---- rcmd2  --------
#
# sys.argv[0]  is alchemy_create_engine5.py
#
