...
#session = <sqlalchemy.orm.session.Session object at 0x7f5a307f8ba8>,  type(session)= <class 'sqlalchemy.orm.session.Session'>


#映射类Departments()的实例hr
session.add(hr)
#2019-04-24 15:28:44,251 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)

session.commit()
#2019-04-24 15:28:44,254 INFO sqlalchemy.engine.base.Engine COMMIT
...
session.close()
#2019-04-24 15:28:44,265 INFO sqlalchemy.engine.base.Engine ROLLBACK
...
#[root@V0 devops_day02]# python3  alchemy_create_engine3.py
...
#-----------OK----------------
#
#2019-04-24 15:28:44,172 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'sql_mode'
#2019-04-24 15:28:44,172 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,174 INFO sqlalchemy.engine.base.Engine SHOW VARIABLES LIKE 'lower_case_table_names'
#2019-04-24 15:28:44,175 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,177 INFO sqlalchemy.engine.base.Engine SELECT DATABASE()
#2019-04-24 15:28:44,177 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,179 INFO sqlalchemy.engine.base.Engine show collation where `Charset` = 'utf8mb4' and `Collation` = 'utf8mb4_bin'
#2019-04-24 15:28:44,179 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,184 INFO sqlalchemy.engine.base.Engine SELECT CAST('test plain returns' AS CHAR(60)) AS anon_1
#2019-04-24 15:28:44,184 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,187 INFO sqlalchemy.engine.base.Engine SELECT CAST('test unicode returns' AS CHAR(60)) AS anon_1
#2019-04-24 15:28:44,187 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,189 INFO sqlalchemy.engine.base.Engine SELECT CAST('test collated returns' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_bin AS anon_1
#2019-04-24 15:28:44,190 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,193 INFO sqlalchemy.engine.base.Engine DESCRIBE `departments`
#2019-04-24 15:28:44,193 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,196 INFO sqlalchemy.engine.base.Engine ROLLBACK
#2019-04-24 15:28:44,199 INFO sqlalchemy.engine.base.Engine 
#CREATE TABLE departments (
#	dep_id INTEGER NOT NULL AUTO_INCREMENT, 
#	dep_name VARCHAR(20) NOT NULL, 
#	PRIMARY KEY (dep_id), 
...
#
#2019-04-24 15:28:44,199 INFO sqlalchemy.engine.base.Engine {}
#2019-04-24 15:28:44,242 INFO sqlalchemy.engine.base.Engine COMMIT
#type(hr)= <class '__main__.Departments'>,   hr= <Departments(dep_name= 人事部)>
#
#
#hr.dep_id= None, hr.dep_name= 人事部, type(hr.dep_id)= <class 'NoneType'>
...
#session = <sqlalchemy.orm.session.Session object at 0x7f5a307f8ba8>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#2019-04-24 15:28:44,248 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 15:28:44,251 INFO sqlalchemy.engine.base.Engine INSERT INTO departments (dep_name) VALUES (%(dep_name)s)
#2019-04-24 15:28:44,251 INFO sqlalchemy.engine.base.Engine {'dep_name': '人事部'}
#2019-04-24 15:28:44,254 INFO sqlalchemy.engine.base.Engine COMMIT
#
#session = <sqlalchemy.orm.session.Session object at 0x7f5a307f8ba8>,  type(session)= <class 'sqlalchemy.orm.session.Session'>
#
#2019-04-24 15:28:44,261 INFO sqlalchemy.engine.base.Engine BEGIN (implicit)
#2019-04-24 15:28:44,262 INFO sqlalchemy.engine.base.Engine SELECT departments.dep_id AS departments_dep_id, departments.dep_name AS departments_dep_name 
#FROM departments 
#WHERE departments.dep_id = %(param_1)s
#2019-04-24 15:28:44,262 INFO sqlalchemy.engine.base.Engine {'param_1': 1}
#
#hr.dep_id= 1
#
#2019-04-24 15:28:44,265 INFO sqlalchemy.engine.base.Engine ROLLBACK
#-----OK ---- rcmd is:
#2019年 04月 24日 星期三 15:28:44 CST
# --------
#
#+-------------------+
#| Tables_in_alchemy |
...
#-----OK ---- rcmd2  --------
#
# sys.argv[0]  is alchemy_create_engine3.py
#
