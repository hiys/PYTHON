...
data = cli_sock.recv(1024) #接收客户端信息，一次接收数据的大小最多是1024字节
...
serverV0 = cli_sock.sendall(b'ServerV0 send all messages to 192.168.1.11 V1 eth1\r\n')
#客户端V1 收到服务端socket对象cli_sock 发送的信息
#b'ServerV0 send all messages to 192.168.1.11 V1 eth1\r\n'
