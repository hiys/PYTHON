...
#[root@room9pc01 urllib_paramiko]# python3  paramiko_sshreturncmd5.py  ipaddrs.txt  ls  home
#__name__ is __main__
#=================   ==================
#
#sys.argv is ['paramiko_sshreturncmd5.py', 'ipaddrs.txt', 'ls', 'home']
#Usage: paramiko_sshreturncmd5.py ipfile "shell command"
#[root@room9pc01 urllib_paramiko]# echo  $?
#1
...
#sys.argv is ['paramiko_sshreturncmd5.py', 'ipaddrs.txt', 'ls  /home']
#Password: 
#<Thread(Thread-1, started 140072373208832)> <class 'threading.Thread'>------thr
#<Thread(Thread-2, started 140072364816128)> <class 'threading.Thread'>------thr
#<Thread(Thread-3, started 140072356423424)> <class 'threading.Thread'>------thr
#<Thread(Thread-6, started 140072331245312)> <class 'threading.Thread'>------thr
#................
#[192.168.0.10] OUT:
#lisi
#peri
