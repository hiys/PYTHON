...
#从服务器端 循环 接收数据
server_data_while_bytes = Client_sock.recv(10)

while len(server_data_while_bytes):
  print(server_data_while_bytes, end = '----bytes\n')

  server_data_while_str = str(server_data_while_bytes, encoding= 'utf8')

  print(server_data_while_str,end = '---while\n')

  server_data_while_bytes = Client_sock.recv(10)
  if  server_data_while_bytes == b'endover':
    print('server_data_while_bytes--break---', server_data_while_bytes)
    break
